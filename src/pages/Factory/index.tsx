...
const Index = () => {
 ...
 useEffect(() => {
  const fetchProvinces = async () => {
    try {
      const response = await fetch('/api/provinces'); // آدرس API برای استان‌ها
      const data = await response.json();
      setProvinces(data); // ذخیره استان‌ها در وضعیت
    } catch (error) {
...
// بارگذاری شهرهای استان انتخاب‌شده از API
useEffect(() => {
  const fetchCities = async (provinceName: string) => {
    if (!provinceName) return; // اگر استانی انتخاب نشده باشد، درخواست ندهیم
    try {
      const response = await fetch(`/api/cities?province=${provinceName}`); // آدرس API برای شهرها
      const data = await response.json();
      setCities(data); // ذخیره شهرها در وضعیت
    } catch (error) {
      console.error("Error fetching cities:", error);
    }
  };
  fetchCities(selectedProvince); // در صورتی که استان انتخاب‌شده تغییر کند، شهرهای جدید را بارگذاری می‌کنیم
}, [selectedProvince]);
  ...
  // };
    ...
    const validation = useFormik({
      ...
      initialValues: {
        ...
        PlateReaderCode,
        WeightReaderCode,
        province: "",  // اضافه کردن استان
        city: "",      // اضافه کردن شهرستان
      },
      validationSchema: Yup.object({
        FactoryName: Yup.string().required('لطفاً نام کارخانه را وارد کنید'),
        FactoryID: Yup.string().required('لطفاً شناسه کارخانه را وارد کنید'),
        FactoryCode: Yup.string().required('لطفاً کد کارخانه را وارد کنید'),
        PhoneNumber: Yup.string().required('لطفاً شماره تماس را وارد کنید'),
        ...
        FactoryStatus: Yup.string().required('لطفاً وضعیت کارخانه را وارد کنید'),
        PlateReaderCode: Yup.string().required('لطفاً کد پلاک‌خوان را وارد کنید'),
        WeightReaderCode: Yup.string().required('لطفاً کد باسکول‌خوان را وارد کنید'),
        province: Yup.string().required('لطفاً استان را انتخاب کنید'),  // اعتبارسنجی استان
        city: Yup.string().required('لطفاً شهرستان را انتخاب کنید'),      // اعتبارسنجی شهرستان
      }),
      onSubmit: (values) => {
        if (isEdit) {
          const updateData = { ...values };
          toast.success(`کارخانه بروز شد`);
          console.log("update", updateData);
          // update user
        } else {
          const newData = { ...values };
          toast.success(`کارخانه جدید ثبت شد`);
          // save new user
    ...
    >
     ...
     <div className="grid grid-cols-1 gap-4 xl:grid-cols-12">
        ...
        <div className="xl:col-span-6 text-gray-800">
          <label className="inline-block mr-1 mb-2 text-base font-medium">نام کارخانه</label>
          <input
            type="text"
        ...
        {/* Factory ID */}
        <div className="xl:col-span-6 text-gray-800">
          <label className="inline-block mr-1 mb-2 text-base font-medium">شناسه کارخانه</label>
          <input
            type="text"
            className="form-input"
            placeholder="شناسه کارخانه"
            name="FactoryID"
            onChange={validation.handleChange}
        ...
        {/* Factory Code */}
        <div className="xl:col-span-6 text-gray-800">
          <label className="inline-block mr-1 mb-2 text-base font-medium">کد کارخانه</label>
          <input
            type="text"
            className="form-input"
            placeholder="کد کارخانه"
            name="FactoryCode"
            onChange={validation.handleChange}
        ...
        {/* Phone Number */}
        <div className="xl:col-span-6 text-gray-800">
          <label className="inline-block mr-1 mb-2 text-base font-medium">شماره تماس</label>
          <input
            type="text"
            className="form-input"
        ...
        {/* Address */}
        <div className="xl:col-span-6 text-gray-800">
          <label className="inline-block mr-1 mb-2 text-base font-medium">آدرس</label>
          <input
            type="text"
            className="form-input"
            placeholder="آدرس"
        ...
        {/* Location */}
        <div className="xl:col-span-6 text-gray-800">
          <label className="inline-block mr-1 mb-2 text-base font-medium">موقعیت مکانی</label>
          <input
            type="text"
            className="form-input"
        ...
        {/* Postal Code */}
        <div className="xl:col-span-6 text-gray-800">
          <label className="inline-block mr-1 mb-2 text-base font-medium">کد پستی</label>
          <input
            type="text"
            className="form-input"
            placeholder="کد پستی"
        ...
        {/* Factory Status */}
        <div className="xl:col-span-6 text-gray-800">
          <label className="inline-block mr-1 mb-2 text-base font-medium">وضعیت کارخانه</label>
          <input
            type="text"
            className="form-input"
            placeholder="وضعیت کارخانه"
            name="FactoryStatus"
            onChange={validation.handleChange}
        ...
        {/* Plate Reader Code */}
        <div className="xl:col-span-6 text-gray-800">
          <label className="inline-block mr-1 mb-2 text-base font-medium">کد پلاک‌خوان</label>
          <input
            type="text"
            className="form-input"
            placeholder="کد پلاک‌خوان"
        ...
        {/* Weight Reader Code */}
        <div className="xl:col-span-6 text-gray-800">
          <label className="inline-block mr-1 mb-2 text-base font-medium">کد باسکول‌خوان</label>
          <input
            type="text"
            className="form-input"
            placeholder="کد باسکول‌خوان"
          ...
          onChange={(e) => {
            ...
            setSelectedProvince(e.target.value); // بروزرسانی استان انتخاب‌شده
          }}
