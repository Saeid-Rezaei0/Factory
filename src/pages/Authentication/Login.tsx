...
import logoDark from "assets/images/logo/Shbrdcrl1000143.jpg";
// import { loginUser, socialLogin } from "slices/thunk"; // me bug
                ...
                <div className="mb-0 w-screen lg:mx-auto lg:w-[500px] card shadow-lg border-none shadow-slate-100 relative">
                    <div className="!px-10 !py-12 card-body">
                        <Link to="/">
                            ...
                            <img src={logoDark} alt="" className="block h-40 w-60 mx-auto dark:hidden" />
                        </Link>
                        <div className="mt-8 text-center">
                            <h4 className="mb-1 text-custom-500 dark:text-custom-500">سامانه توزیع آرد هاویر</h4>
                        ...
                        <form className="mt-10" id="signInForm"
                            ...
                            <div className="mb-3">
                                <label htmlFor="email" className="inline-block mb-2 text-base font-medium">نام کاربری </label>
                                <input
                                    type="text"
                                    id="email"
                                    name="email"
                            ...
                            <div className="mb-3">
                                <label htmlFor="password" className="inline-block mb-2 text-base font-medium">رمز عبور</label>
                                <input
                                    type="password"
                                    id="password"
                                    name="password"
                            ...
                            <div>
                                <div className="flex items-center gap-2">
                                    ...
                                    <label htmlFor="checkboxDefault1" className="inline-block text-base font-medium align-middle cursor-pointer">منو به خاطر بسپارید</label>
                                </div>
